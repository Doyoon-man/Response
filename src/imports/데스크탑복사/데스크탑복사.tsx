import svgPaths from "./svg-wcom07ex0g";
import img from "./96ae70cbe7704fabab0a24e07eebb6c76a9d3b5d.png";
import imgImgi3MainVisualImg011 from "./2cf1b7f411cfe9894023b339a7539ca73afd4f91.png";

function Logo() {
  return (
    <div className="col-1 h-[53.563px] ml-0 mt-0 relative row-1 w-[60.133px]" data-name="Logo">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 60.1335 53.563">
        <g id="Logo">
...
function Component1() {
  return (
    <div className="bg-[#fffefe] shrink-0 sticky top-0 w-full z-[7]" data-name="헤더">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex isolate items-center justify-between px-[128px] relative w-full">
...
function Component9() {
  return (
    <div className="bg-[#69bc42] content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="상단애니메이션1">
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#fffefe] text-[18px] whitespace-nowrap">
...
function Component11() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Bold',sans-serif] gap-[8px] items-start relative shrink-0 text-[64px] w-full" data-name="메뉴글_중간글">
...
function Component10() {
  return (
    <div className="content-stretch flex flex-col gap-[27px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="상단애니메이션1">
      <Component11 />
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center relative shrink-0 text-[#515151] text-[18px] w-full">
...
function Component12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[300px]" data-name="캐러셀이미지">
...
function Component14() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0" data-name="플레이팝업">
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-black text-center w-[24px]">
        <p className="leading-[normal]">01</p>
      </div>
      <Component15 />
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#adadad] text-[18px] whitespace-nowrap">
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-center relative shrink-0" data-name="플레이창">
      ...
      <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[11px]" data-name="플레이버튼">
        <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-black w-full">
          <p className="leading-[normal]">{`>`}</p>
        </div>
      </div>
    </div>
...
function Component7() {
  return (
    <div className="content-center flex flex-wrap gap-[0px_16px] h-[440px] items-center justify-center overflow-clip px-[128px] relative rounded-bl-[32px] rounded-br-[32px] shrink-0 w-[1280px] z-[6]" data-name="상단메뉴캐러셀">
...
function Component18() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="글묶음1">
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center min-w-full relative shrink-0 text-[#3232c8] text-[18px] w-[min-content]">
        <p className="leading-[normal]">About Foundation</p>
      </div>
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center relative shrink-0 text-[40px] text-black whitespace-nowrap">
...
function Component19() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative w-full" data-name="글묶음2">
      <div className="flex flex-[1_0_0] flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#515151] text-[18px]">
...
function Component22() {
  return <div className="absolute left-0 size-[51px] top-[-0.5px]" data-name="손모양아이콘" />;
}
...
function Component24() {
  return <div className="bg-[#e6e6e6] h-[52px] rounded-[4px] shrink-0 w-[51px]" data-name="아이콘" />;
}
...
function Component20() {
  return (
    <div className="content-center flex flex-wrap gap-[16px] items-center justify-center relative shrink-0 w-full" data-name="소개글상자">
      <div className="h-[216px] relative rounded-[8px] shrink-0 w-[300px]" data-name="혜안재단 소개 글상자">
...
function Component17() {
  return (
    <div className="h-[465px] relative shrink-0 w-full z-[5]" data-name="섹션1">
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[32px] relative size-full">
        <div className="h-[187px] relative shrink-0 w-full" data-name="글상자_제네럴">
          <div className="content-stretch flex flex-col gap-[24px] items-start px-[128px] relative size-full">
            <Component18 />
            <Component19 />
          </div>
        </div>
...
function Component30() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="글묶음1">
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center relative shrink-0 text-[#3232c8] text-[18px] w-full">
        <p className="leading-[normal]">Our Ideal Talent</p>
      </div>
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center relative shrink-0 text-[40px] text-black w-full">
...
function Component28() {
  return (
    <div className="relative shrink-0 w-full z-[4]" data-name="섹션2_헤더">
      <div className="flex flex-row items-end size-full">
        <div className="content-end flex flex-wrap gap-y-[32px] items-end justify-between px-[128px] relative w-full">
          <Component29 />
          <div className="bg-[#fffefe] content-stretch flex gap-[8px] h-[42px] items-center justify-center px-[24px] py-[16px] relative rounded-[24px] shrink-0 w-[216px]" data-name="버튼_제네럴">
            ...
            <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#000064] text-[18px] whitespace-nowrap">
...
function Component38() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[143px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="섹션3_글내용">
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center relative shrink-0 text-[#515151] text-[22px] whitespace-nowrap">
        <p className="leading-[normal]">희망장학사업</p>
      </div>
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center min-w-full relative shrink-0 text-[#adadad] text-[18px] w-[min-content]">
...
function Component43() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <div className="h-[84.276px] relative shrink-0 w-[80px]" data-name="섹션3_아이콘">
        <div className="absolute h-[50.566px] left-0 top-0 w-[80px]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 84.2763">
            <path d={svgPaths.p162df6f0} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Component50() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <div className="aspect-[16/16] flex-[1_0_0] min-h-px min-w-px relative" data-name="섹션3_아이콘">
        <div className="absolute inset-[5.21%_35.37%]" data-name="Vector">
          <div className="absolute inset-[-0.7%_-2.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.4133 72.6667">
              <path d={svgPaths.p21189800} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute flex inset-[14.93%_3.89%] items-center justify-center">
          <div className="-rotate-30 flex-none h-[30.175px] w-[92.365px]">
            <div className="relative size-full" data-name="Vector">
              <div className="absolute inset-[-2.14%_-0.7%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 72.6667 24.4133">
                  <path d={svgPaths.p38746100} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
        ...
        <div className="absolute flex inset-[14.93%_3.89%] items-center justify-center">
          <div className="-rotate-60 flex-none h-[92.365px] w-[30.175px]">
            <div className="relative size-full" data-name="Vector">
              <div className="absolute inset-[-0.7%_-2.14%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.4133 72.6667">
                  <path d={svgPaths.p21189800} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <div className="absolute inset-[44.39%_44.39%_44.38%_44.39%]" data-name="Vector">
          <div className="absolute inset-[-5.57%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.98333 9.98333">
              <path d={svgPaths.p27910700} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[14.22%_28.38%_37.17%_52.72%]" data-name="Vector">
          <div className="absolute inset-[-1.29%_-3.31%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.1202 39.8868">
              <path d={svgPaths.p255fce80} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function Group1() {
  return (
    <div className="-translate-y-1/2 absolute h-[37.94px] left-[9.06%] right-[9.06%] top-1/2" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.1631 37.9403">
        <g id="Group">
          <path d={svgPaths.p1ef47880} fill="var(--fill-0, black)" id="Vector" />
          <path d={svgPaths.pd917680} fill="var(--fill-0, black)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Component57() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <div className="aspect-[55.16303253173828/57.94032669067383] flex-[1_0_0] min-h-px min-w-px overflow-clip relative" data-name="섹션3_아이콘">
        <Group1 />
      </div>
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents inset-[12.5%_8.27%_20.83%_8.34%]" data-name="Group">
      <div className="absolute inset-[12.5%_8.27%_35.12%_8.34%]" data-name="Vector">
        <div className="absolute inset-[-3.18%_-2%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 69.384 44.5717">
            <path d={svgPaths.p165ca500} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[20.83%] left-1/4 right-1/4 top-[48.22%]" data-name="Vector">
        <div className="absolute inset-[-5.38%_-3.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42.6667 27.4279">
            <path d={svgPaths.p3a2b9100} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          </svg>
        </div>
      </div>
    </div>
...
function Component64() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[96px]" data-name="섹션3_아이콘">
      <div className="aspect-[32/32] flex-[1_0_0] min-h-px min-w-px overflow-clip relative" data-name="섹션3_아이콘">
        <Group2 />
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-[#f5f5ff] relative shrink-0 w-full z-[3]" data-name="섹션3">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[128px] py-[64px] relative w-full">
          <Component33 />
          <Component36 />
        </div>
      </div>
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-center p-[16px] relative w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="공지사항란">
              <div className="content-stretch flex gap-[13px] items-center relative shrink-0 w-full" data-name="장학내용">
                <p className="font-['Pretendard:Medium',sans-serif] h-[27px] leading-[normal] not-italic relative shrink-0 text-[#e6e6e6] text-[18px] text-center w-[5px]">.</p>
                <Component72 />
...
function Component78() {
  return (
    <div className="bg-[#fffefe] flex-[1_0_0] min-h-px min-w-px overflow-clip relative rounded-[4px] w-full" data-name="메뉴내용이미지">
      <div className="absolute left-[10px] size-[60px] top-[9px]" data-name="섹션_4아이콘">
    ...
    <div className="absolute inset-[8.33%]" data-name="Group">
      <div className="absolute inset-[-4%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 54 54">
          <g id="Group">
            <path d={svgPaths.p24da7c00} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            <path d="M2 27H52" id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            <path d={svgPaths.p18efb0c0} id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            <path d={svgPaths.p1afda380} id="Vector_4" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="absolute inset-[8.33%_16.67%]" data-name="Group">
      <div className="absolute inset-[-4%_-5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 54">
          <g id="Group">
            <path d={svgPaths.p29ab6e00} id="Vector" stroke="var(--stroke-0, black)" strokeWidth="4" />
            <path d={svgPaths.p27be7e00} id="Vector_2" stroke="var(--stroke-0, black)" strokeWidth="4" />
            <path d="M12 14.5H32M12 23.25H24.5" id="Vector_3" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeWidth="2" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="bg-[#fffefe] flex-[1_0_0] min-h-px min-w-px overflow-clip relative rounded-[4px] w-full" data-name="메뉴내용이미지">
      <div className="absolute left-[10px] size-[60px] top-[9px]" data-name="섹션_4아이콘">
        <div className="absolute inset-[5.21%_5.21%_5.2%_5.21%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 53.75 53.7525">
            <path clipRule="evenodd" d={svgPaths.p90e4c80} fill="var(--fill-0, black)" fillRule="evenodd" id="Vector" />
          </svg>
        </div>
        <div className="absolute bottom-[41.67%] left-[22.92%] right-[39.58%] top-1/2" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.5 5">
            <path d={svgPaths.p1ed44100} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full z-[2]" data-name="애니메이션_섹션4">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-center px-[128px] relative w-full">
          ...
          <div className="bg-[#deeff9] relative rounded-[8px] shrink-0 w-full" data-name="하단메뉴">
            <div className="overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex items-start justify-between p-[24px] relative w-full">
                <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center relative shrink-0 w-[80px]" data-name="메뉴내용">
                  <Component78 />
...
function Component83() {
  return (
    <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="경기도교육청모음">
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#515151] text-[18px] whitespace-nowrap">
        <p className="leading-[normal]">경기도교육청</p>
      </div>
    </div>
  );
}
...
function Component84() {
  return (
    <div className="content-stretch flex gap-[3px] items-center relative shrink-0" data-name="국세청모음">
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#515151] text-[18px] whitespace-nowrap">
        <p className="leading-[normal]">국세청</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="하단글_모음">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[47px] items-center justify-center px-[47px] py-[16px] relative w-full">
          <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-black whitespace-nowrap">
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[64px] isolate items-center py-[16px] relative size-full" data-name="데스크탑_복사">
      <div className="absolute bg-[#fffefe] content-stretch flex flex-col isolate items-center justify-center left-[398px] p-[8px] rounded-[24px] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.25)] size-[31px] top-[765px] z-[8]" data-name="TOP버튼">
        <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-black w-full z-[1]">
          <p className="leading-[normal]">↑</p>
        </div>
      </div>
      <Component1 />
      ...
      <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full z-[1]" data-name="스폰서들">
        <Component82 />
        <button className="content-stretch cursor-pointer flex font-['Pretendard:Medium',sans-serif] gap-[8px] items-center justify-center leading-[0] not-italic p-[8px] relative shrink-0 text-[#515151] text-[18px] text-left whitespace-nowrap" data-name="관련사이트 보이기">
