import svgPaths from "./svg-aj01ypy8y2";
...
function Component1() {
  return (
    <div className="bg-[#fffefe] content-stretch flex isolate items-center justify-between shrink-0 sticky top-0 w-full z-[7]" data-name="헤더">
...
function Component11() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Bold',sans-serif] gap-[8px] items-start relative shrink-0 text-[48px] w-full" data-name="메뉴글_중간글">
...
function Component12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[176px]" data-name="캐러셀이미지">
...
function Component7() {
  return (
    <div className="content-center flex flex-wrap gap-[0px_16px] items-center justify-center overflow-clip relative rounded-bl-[32px] rounded-br-[32px] shrink-0 size-[440px] z-[6]" data-name="상단메뉴캐러셀">
...
function Component18() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="글묶음1">
      ...
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center relative shrink-0 text-[32px] text-black whitespace-nowrap">
...
function Component20() {
  return (
    <div className="content-center flex flex-wrap gap-[16px] items-center justify-center relative shrink-0 w-full" data-name="소개글상자">
      <div className="h-[200px] relative rounded-[8px] shrink-0 w-[400px]" data-name="혜안재단 소개 글상자">
...
function Component17() {
  return (
    <div className="h-[860px] relative shrink-0 w-full z-[5]" data-name="섹션1">
...
function Component30() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start leading-[0] not-italic relative shrink-0 w-full" data-name="글묶음1">
      ...
      <div className="flex flex-col font-['Pretendard:SemiBold',sans-serif] justify-center relative shrink-0 text-[32px] text-black w-full">
  ...
  return (
    <div className="relative shrink-0 w-full z-[4]" data-name="섹션2_헤더">
      <div className="flex flex-row items-end size-full">
        <div className="content-end flex flex-wrap gap-y-[32px] items-end justify-between px-[16px] relative w-full">
          <Component29 />
...
function Component43() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[80px]" data-name="섹션3_아이콘">
      <div className="h-[50.566px] relative shrink-0 w-[48px]" data-name="섹션3_아이콘">
        <div className="absolute h-[50.566px] left-0 top-0 w-[48px]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 50.5658">
            <path d={svgPaths.p9b1ffc0} fill="var(--fill-0, black)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex items-center justify-center overflow-clip p-[8px] relative shrink-0 size-[80px]" data-name="섹션3_아이콘">
      <div className="aspect-[16/16] flex-[1_0_0] min-h-px min-w-px relative" data-name="섹션3_아이콘">
        <div className="absolute inset-[5.21%_35.37%]" data-name="Vector">
          <div className="absolute inset-[-0.87%_-2.67%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.7307 58.3333">
              <path d={svgPaths.p2872b400} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute flex inset-[14.93%_3.89%] items-center justify-center">
          <div className="-rotate-30 flex-none h-[30.175px] w-[92.365px]">
            <div className="relative size-full" data-name="Vector">
              <div className="absolute inset-[-2.67%_-0.87%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 58.3333 19.7307">
                  <path d={svgPaths.p13ef3d80} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </div>
          </div>
        ...
        <div className="absolute inset-[44.39%_44.39%_44.38%_44.39%]" data-name="Vector">
          <div className="absolute inset-[-6.96%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.18667 8.18667">
              <path d={svgPaths.p22820180} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[14.22%_28.38%_37.17%_52.72%]" data-name="Vector">
          <div className="absolute inset-[-1.61%_-4.13%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.0962 32.1095">
              <path d={svgPaths.pfbdc3c0} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="absolute contents inset-[12.5%_8.27%_20.83%_8.34%]" data-name="Group">
      <div className="absolute inset-[12.5%_8.27%_35.12%_8.34%]" data-name="Vector">
        <div className="absolute inset-[-3.98%_-2.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56.0405 36.1907">
            <path d={svgPaths.p22b2c700} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[20.83%] left-1/4 right-1/4 top-[48.22%]" data-name="Vector">
        <div className="absolute inset-[-6.73%_-4.17%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34.6667 22.4757">
            <path d={svgPaths.p3e484aef} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f5f5ff] relative shrink-0 w-full z-[3]" data-name="섹션3">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center px-[16px] py-[64px] relative w-full">
          <Component33 />
          <Component36 />
        </div>
      </div>
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-center p-[16px] relative w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="공지사항란">
              <div className="content-stretch flex gap-[13px] items-center relative shrink-0 w-full" data-name="장학내용">
                ...
                <Component72 />
                <div className="flex flex-col font-['Pretendard:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#adadad] text-[12px] whitespace-nowrap">
  ...
  return (
    <div className="relative shrink-0 w-full z-[2]" data-name="애니메이션_섹션4">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-center px-[16px] relative w-full">
          <div className="content-stretch flex flex-col gap-[24px] h-[187px] items-start relative shrink-0 w-full" data-name="글상자_제네럴">
            <Component66 />
            <Component67 />
          </div>
            ...
            <div className="overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex items-start justify-between p-[24px] relative w-full">
                <div className="content-stretch flex flex-col gap-[8px] h-[100px] items-center relative shrink-0 w-[80px]" data-name="메뉴내용">
                  <Component78 />
                  <div className="flex flex-col font-['Pretendard:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center w-full">
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[48px] isolate items-center py-[16px] relative size-full" data-name="데스크탑_복사">
      <div className="absolute bg-[#fffefe] content-stretch flex flex-col isolate items-center justify-center left-[398px] p-[8px] rounded-[24px] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.25)] size-[31px] top-[765px] z-[8]" data-name="TOP버튼">
        <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black w-full z-[1]">
          <p className="leading-[normal]">↑</p>
        </div>
      </div>
      <Component1 />
